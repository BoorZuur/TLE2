    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('login') }}"
                   class="px-4 py-2 text-gray-700 hover:text-[#36298B] transition">Inloggen</a>
                <a href="{{ route('register') }}"
                   class="px-4 py-2 bg-[#E2006A] text-white rounded-lg hover:bg-pink-900 transition">Registreren</a>
            </div>
        </div>
    </div>
</nav>
<header class="bg-white dark:bg-gray-900">
    <div class="container mx-auto px-6 py-16 text-center">
        <div class="mx-auto max-w-lg">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">Welkom bij <span
                    class="bowlby-one-sc-regular">NMklikker</span></h1>
            <p class="mt-6 text-gray-500 dark:text-gray-300">NMklikker is een clicker game waar je dieren en gebieden
                van Natuurmonumenten ingame kan verzamelen.</p>
            <p class="mt-6 text-gray-500 dark:text-gray-300">Je leert welke dieren in welke soorten gebieden binnen
            ...
            <button
                class="mt-6 rounded-lg bg-[#E2006A] hover:bg-pink-900 px-6 py-2.5 text-center text-sm font-medium capitalize leading-5 text-white hover:bg-[#E2006A] focus:outline-none lg:mx-0 lg:w-auto">
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3">
            <div class="rounded-lg border p-8 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-white">1. Aai je dier</h3>
            ...
            <div class="rounded-lg border p-8 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-white">2. Verzorg je dier</h3>
                <p class="mt-4 text-gray-500 dark:text-gray-300">
            ...
            <div class="rounded-lg border p-8 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-white">3. Koop nieuwe dieren</h3>
                <p class="mt-4 text-gray-500 dark:text-gray-300">
        ...
        <div class="mt-16">
            <h2 class="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">
                Verschillende pagina's</h2>
            <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12">
                <div class="rounded-lg border p-8 dark:border-gray-700">
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Dieren</h3>
                    <p class="mt-4 text-gray-500 dark:text-gray-300">
                        Verzorg je dieren door ze te voeren, wassen en laten rusten om ze gelukkig en gezond te houden.
                    </p>
                </div>
                <div class="rounded-lg border p-8 dark:border-gray-700">
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Gebieden</h3>
                    <p class="mt-4 text-gray-500 dark:text-gray-300">
                        Ontdek verschillende natuurgebieden en plaats je dieren in hun natuurlijke habitat.
                    </p>
                </div>
                <div class="rounded-lg border p-8 dark:border-gray-700">
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Collectie</h3>
                    <p class="mt-4 text-gray-500 dark:text-gray-300">
                ...
                <div class="rounded-lg border p-8 dark:border-gray-700">
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Winkel</h3>
                    <p class="mt-4 text-gray-500 dark:text-gray-300">
