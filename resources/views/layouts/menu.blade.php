<nav class="bg-[#89B934] border-b border-gray-200">
    <div class="max-w-8xl gap-4 mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div class="flex items-center">
            <img src="{{ asset('images/natuurmonumenten.png') }}" alt="Natuurmonumenten logo"
